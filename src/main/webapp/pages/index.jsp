...
<c:url value="/resources/js/index.js" var="indexJS" />
...
<body>
	...
	<div class="content container">
		...
		<div class="row title" id="tagline">Find <font color='white'>WORK</font> near you
	</div>
		<div class="row search-box primary-text"><input id="input-address" type="text" name="address" placeholder="City, State, or ZIP code" autocomplete="off" spellcheck="false">
			<div class="btn btn-default search"><i class="fa fa-search"></i></div></div>
			</div>
		<div class="row secondary-text" id="subheading" onclick="swap()">Find <font color='white'>people</font> instead
	</div>
</div>
	...
	<form method="post" class="hidden" action="nearbyJobSeekers" id="people-form"><input id="people-address" type="text" name="address"> <select name="interest">
			<option value="0" selected></option>
	</select><input name="latitude" value="0"></form>
	<form method="post" class="hidden" action="nearbyJobs" id="jobs-form"><input id="jobs-address" type="text" name="address"> <select name="industry">
			<option value="0" selected></option>
	</select><input name="latitude" value="0"></form>
</body>
</html>
