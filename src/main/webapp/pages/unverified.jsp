...
<body>
	...
	<c:if test="${not empty message}">
		<div id="message">
			<div id="inner-message" class="alert alert-error">${message}</div>
		</div>
	</c:if>
	...
	<div class="content container">
		...
		<h1> It looks like you have not verified your email!</h1>
		<h2> Do you need us to send you another one? </h2>
		<hr>
		<div class="btn btn-default">Yes Please!</div>
		<p> Make sure to check your spam folder if you still not see it! </p>
	</div>
